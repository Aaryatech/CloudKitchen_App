...
//    var getaddresses= await Geocoder.local.findAddressesFromCoordinates(Coordinates(latLng.latitude, latLng.longitude));
//     var first = getaddresses.first;
...
//               children: [
//                 Container(
//                   height:showUi?MediaQuery.of(context).size.height*.39: MediaQuery.of(context).size.height*.69,
//                   child: GoogleMap(
...
//               ),):Container(),
//
//             showUi?Container():isAddressAvailable?Positioned(
//               top: 40,
//               child: Container(
//                 margin: EdgeInsets.all(16),
...
//
//                         ListTile(
//                           title: Text('Your food will be delivered here',style: Theme.of(context).textTheme.subtitle1.copyWith(color: Colors.white) ,),
//                           subtitle: Text('Drag marker to change location',style: Theme.of(context).textTheme.caption.copyWith(color: Colors.white) ),
//                           enabled: true,
//                           selected: true,
