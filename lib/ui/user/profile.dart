                              ...
                              children: [
                                CircleAvatar(
                                    ...
                                    backgroundImage: widget
                                        ...
                                        : NetworkImage(
                                            '$profileImageUrl${widget.allFrenchisiViewModel.url}') //:FileImage(_image) ,
                                    ),
                                Column(
                                  ...
                                  children: <Widget>[
                                    Container(
                                      child: Text(
                                        widget.allFrenchisiViewModel.getCustName() ??
                                            "",
                                    ...
                                    Text(widget.allFrenchisiViewModel.getCustMobile()??"",
                                        style: Theme.of(context)
                                            .textTheme
                                            .subtitle1
                                            .copyWith(
...
//Launch the Review Flow.
                                    launch(
                                        'https://play.google.com/store/apps/details?id=com.madhvi.cloudkitchen');
                                  },
                                  child: Padding(
                                    padding: const EdgeInsets.all(8.0),
                                    child: Row(
                                ...
                                InkWell(
                                  onTap: () {
                                    Share.share(
                                        'Hey buddy! I just downloaded this madhvi food delivery mobile application. I recommend you to try this https://play.google.com/store/apps/details?id=com.madhvi.cloudkitchen');
                                  },
                                  child: Padding(
                                    padding: const EdgeInsets.all(8.0),
                                    child: Row(
