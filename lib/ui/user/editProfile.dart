  ...
  Future getImage() async {
    ...
    setState(() {
      if (pickedFile != null) {
        ...
        widget.allFrenchisiViewModel.saveUserProfileImage(_image);
...
Widget  getDatePicker(){
    return  DateTimePicker(
      ...
      // initialValue: profileDetailsViewModel
      //     .custDob ==
      //     null
      //     ? '${DateTime.now()}'
      //     : '${profileDetailsViewModel.custDob} ', //${DateTime(int.parse(profileDetailsViewModel.customerDetails?.custDob?.split('-')[0]), int.parse(profileDetailsViewModel.customerDetails?.custDob?.split('-')[1]), int.parse(profileDetailsViewModel.customerDetails?.custDob?.split('-')[2])) ?? '${DateTime.now()}'}',
      ...
      child: Observer(
        builder: (_) => Stack(
          children: [
            Scaffold(
                      ...
                      onPressed: () {
                        if (isNetWorkAvailable) {
                          ...
                          _scaffoldKey.currentState.showSnackBar(SnackBar(
                            content: Text("Please check network connection"),
                ...
                body: Container(
                  child: (!isNetWorkAvailable)
                      ? NoNetworkUi()
                      : SingleChildScrollView(child: Observer(builder: (_) {
                          usernameController.value = TextEditingValue(
                            text: profileDetailsViewModel.username,
                            selection: TextSelection.fromPosition(
                              TextPosition(
                                  offset:
                                      profileDetailsViewModel.username.length),
                            ),
                          );
                          ...
                          emailController.value = TextEditingValue(
                            ...
                            selection: TextSelection.fromPosition(
                              TextPosition(
                                  offset: profileDetailsViewModel.email.length),
                            ),
                          );
                          ...
                          phoneNumberController.value = TextEditingValue(
                            ...
                            selection: TextSelection.fromPosition(
                              TextPosition(
                                  offset: profileDetailsViewModel
                                      .phoneNumber.length),
                            ),
                          );
                              ...
                              builder:(_)=> Column(
                                ...
                                children: [
                                    ...
                                    children: [
                                      CircleAvatar(
                                        ...
                                        backgroundImage: _image == null
                                            ? '${widget.allFrenchisiViewModel.url ?? ""}' ==
                                                    ""
                                                ? AssetImage('images/man.png')
                                                : NetworkImage(
                                                    '$profileImageUrl${widget.allFrenchisiViewModel.url}')
                                            : FileImage(_image),
                                      ),
                                      Positioned(
                                          bottom: 0,
                                  ...
                                  TextField(
                                    ...
                                    onChanged: ((str) {
                                      profileDetailsViewModel.username = str;
                                    }),
                                    decoration: new InputDecoration(
                                      hintText: 'Enter Your Name',
                                      labelText: 'Name',
                                      errorText: profileDetailsViewModel
                                          .profileDetailsErrorState.username,
                                  ...
                                  TextField(
                                    ...
                                    decoration: new InputDecoration(
                                      ...
                                      labelText: 'Number',
                                      errorText: profileDetailsViewModel
                                          .profileDetailsErrorState.phoneNumber,
                                  ...
                                  TextField(
                                    ...
                                    onChanged: ((str) {
                                      profileDetailsViewModel.email = str;
                                    }),
                                    decoration: new InputDecoration(
                                      hintText: 'Enter Your Email Address',
                                      labelText: 'Email',
                                      errorText: profileDetailsViewModel
                                          .profileDetailsErrorState.email,
                                  ...
                                  Row(
                                    ...
                                    children: <Widget>[
                                      ...
                                      Radio(
                                        ...
                                        value:
                                            profileDetailsViewModel.gender == null
                                                ? 1
                                                : profileDetailsViewModel.gender,
                                        groupValue: 1,
                                        onChanged: (val) {
                                          setState(() {
                                    ...
                                    child: GestureDetector(
                                      onTap: () async {
                                        if (isNetWorkAvailable) {
                                          ...
                                          saveCustomer.custId =
                                              await profileDetailsViewModel
                                                  .getCustID();
                                          saveCustomer.whatsappNo = "";
                                          saveCustomer.profilePic =widget.allFrenchisiViewModel.url;
                                          saveCustomer.gender = id;
                                          saveCustomer.custDob =
                                              profileDetailsViewModel
                                                  .customerDetails?.custDob;
            ...
            (profileDetailsViewModel.isLoading || widget.allFrenchisiViewModel.isLoading)
                ? Container(
