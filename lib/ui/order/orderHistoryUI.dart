...
class _OrderHistoryState extends State<OrderHistory> {
  ...
  List<Widget>  getItems(List<DetailList> list){
    ...
    list.forEach((element) {
      widgets.add(Text('${element.exInt1} X ${element.itemName} [${element.exFloat2} ${element.exVar1}]',style: Theme.of(context).textTheme.caption.copyWith(fontFamily: 'Metropolis'),)
      );
    });
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      key: _scaffoldKey,
      appBar: AppBar(
        title: Text('Your Order History',style: Theme.of(context)
            .textTheme
            .headline6
            .copyWith(color: Colors.white),),
        actions: [
                  ...
                  child: InkWell(
                    ...
                    child: Column(
                      ...
                      children: <Widget>[
                                  ...
                                  child: Column(
                                    ...
                                    children: <Widget>[
                                      ...
                                      SizedBox(
                                        ...
                                        child: Text(
                                            '${item.landmark}',style:Theme.of(context).textTheme.caption.copyWith(fontWeight: FontWeight.normal).copyWith(color:Colors.black)),
                                      ),
                        ...
                        Text(
                            'Items',
                            style:Theme.of(context).textTheme.bodyText2.copyWith(fontWeight: FontWeight.normal).copyWith(color:Colors.grey)),
                        SizedBox(height: 4,),
                        // Text(,style:Theme.of(context).textTheme.subtitle1.copyWith(fontWeight: FontWeight.bold).copyWith(color:Colors.black)),
                        ...
                        SizedBox(height: 4,),
                        Text(
                            '${item.insertDateTime}',style:Theme.of(context).textTheme.bodyText1.copyWith(color:Colors.black,fontFamily: 'Metropolis')),
                        ...
                        SizedBox(height: 4,),
                        Text(
                            '${item.totalAmt}',style:Theme.of(context).textTheme.bodyText1.copyWith(color:Colors.black,fontFamily: 'Metropolis')),
                        ...
                        Row(
                          ...
                          children: <Widget>[
                            Text(
                                ...
                                style:Theme.of(context).textTheme.bodyText2.copyWith(fontWeight: FontWeight.bold).copyWith(color:Colors.black,fontFamily: 'Metropolis')),
