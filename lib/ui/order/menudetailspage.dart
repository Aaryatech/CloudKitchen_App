                          ...
                          Container(
                            ...
                            child: Column(
                              ...
                              //   widget.itemData.relItemList.isNotEmpty? Text('Related Items',style: Theme.of(context).textTheme.subtitle1):Container(),
                                                                ...
                                                                widget.itemData.relItemList.isNotEmpty?Text('Related Products',style: Theme.of(context).textTheme.subtitle1.copyWith(fontFamily: 'Metropolis Semi Bold')):Container(),
                                    ...
                                    child: SizedBox(
                                      ...
                                      Center(
                                        child: RaisedButton(
                                            ...
                                            SnackBar(
                                            content: Text('Rating & Review submitted successfully',style: TextStyle(color: Colors.white),),
