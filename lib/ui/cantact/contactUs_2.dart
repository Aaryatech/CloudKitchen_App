                    ...
                    TextField(
                      ...
                      decoration: new InputDecoration(
                          ...
                          prefixIcon: Padding(
                            ...
                            child: Icon(Icons
                                .question_answer), // Change this icon as per your requirement
                          ),
                          border: new OutlineInputBorder(
                            borderRadius: const BorderRadius.all(
                              const Radius.circular(2.0),
                      ...
                      child: GestureDetector(
                        onTap: () async {
                          ...
                          if (emailController.text == "" ||
                              !emailController.text.toString().isEmail()) {
                            isValid = false;
                            setState(() {
                          ...
                          if (isValid) {
                            ...
                            await contactUSViewModel
                                .saveContactUS(saveCustomer);

                            if (!contactUSViewModel
                                .httpResponseMian.info.error) {
