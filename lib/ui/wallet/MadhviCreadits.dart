            ...
            Scaffold(
              ...
              body: SingleChildScrollView(child: Observer(builder: (_) {
                if (madhviCreditViewModel.madhviCreditList != null) {
                  madhvi =
                      madhviCreditViewModel.madhviCreditList.walletTransaction;
                }
                return Container(
                  child: Padding(
                    ...
                    child: Column(
                      ...
                      children: <Widget>[
                        Text(
                            'Save money by using Madhvi Credits when paying online for an order',
                            style: Theme.of(context)
                                .textTheme
                                .bodyText2
                        ...
                        Row(
                          children: [
                            ...
                            Text('${madhviCreditViewModel.total}',
                                style: Theme.of(context)
                                    .textTheme
                                    .headline6
                        ...
                        (!madhviCreditViewModel.isLoading &&
                                madhviCreditViewModel.madhviCreditList
                            ...
                            ? ListView.separated(
                                ...
                                itemBuilder: (context, index) {
                                  bool cr = madhvi[index].transcType == 'CR'
                                      ? true
                                      : false;

                                  return ListTile(
                                      title: Text(
                                        '${madhvi[index].orderDate}',
                                        style: Theme.of(context)
                                            .textTheme
                                            .subtitle2,
                                      ),
