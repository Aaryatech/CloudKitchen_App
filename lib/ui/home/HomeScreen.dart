                        ...
                        Observer(
                          builder:(_)=> Row(
                              children: [
                                ...
                                // FlatButton(onPressed:(){
                                //
                                // }, child: Text('Chnage Outlet',style: Theme.of(context).textTheme.bodyText2.copyWith(color: Theme.of(context).primaryColor),))
                    ...
                    children: <Widget>[
                      widget.itemData.imageList.isEmpty?  Padding(
                        ...
                        children: <Widget>[
                          ...
                          Image.network('${imageUrl}${widget.itemData.imageList[0].imageName}',width: MediaQuery.of(context).size.width*.25,height: 100,):Container(),
