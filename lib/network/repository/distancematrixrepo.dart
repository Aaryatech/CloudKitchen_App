...
class DistancematrixRepo {
  ...
  Future<HttpResponse> DistanceMatrixApi(
      String origin, String destination) async {
    HttpResponse httpResponse = HttpResponse();

    try {
      Response response = await Dio().get(
          "https://maps.googleapis.com/maps/api/distancematrix/json?units=metric&origins=$origin&destinations=$destination&key=AIzaSyBahlnISPYhetj3q50ADqVE6SECypRGe4A");
