...
class AllFranchiseRepo {
  ...
  Future<HttpResponse> getFranchiseDetailsById(String id) async {
    ...
    Response responce =
        await httpClient.get('https://pos.madhvi.in/uploads/appjson/$id.json');
    print(responce.data);
  ...
  Future<HttpResponse> getFranchiseDetailsSorted(int frId, int sortId) async {
    ...
    Response responce =
        await httpClient.post('${endPoints.Auth().franchiseDatabySort}$param');
    // print(responce.data);
  ...
  Future<HttpResponse> getFranchiseDetailsRating(
      int frId, String rating) async {
    HttpResponse httpResponse = HttpResponse();

    String param = '?frId=$frId&ratings=$rating';

    Response responce = await httpClient
        .post('${endPoints.Auth().franchiseDatabyRating}$param');
