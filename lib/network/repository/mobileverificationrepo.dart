...
MobileVerificationRepo(){
  ...
  Future<bool> mobileVerification(String mobile,String otp) async {
    try {
      Response response = await Dio().get("https://smsapi.24x7sms.com/api_2.0/SendSMS.aspx?APIKEY=pJMAaVPuGbh&MobileNo=$mobile&SenderID=MDVDRY&Message=We welcome You to Madhvi!\nYour OTP to change your password is $otp.&ServiceName=TEMPLATE_BASED");
      print(response);
