...
MobileVerificationRepo(){
  ...
  Future<bool> mobileVerification(String mobile,String otp) async {
    try {
      ...
      Response response = await Dio().get("https://smsapi.24x7sms.com/api_2.0/SendSMS.aspx?APIKEY=pJMAaVPuGbh&MobileNo=$mobile&SenderID=MDVDRY&Message=<%23> $otp is your Madhvi verification code. Enjoy :-) SBwxBGSuW32&ServiceName=TEMPLATE_BASED");
      print(response);
