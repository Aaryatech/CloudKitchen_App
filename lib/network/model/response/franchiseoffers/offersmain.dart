...
class OffersMain {
  ...
  OffersMain(this.info, this.offerList, this.additionalCharges,
      this.deliveryCharges, this.custWalletTotal);
  factory OffersMain.fromJson(Map<String, dynamic> json) =>
      _$OffersMainFromJson(json);
...
class DeliveryCharges {
  ...
  DeliveryCharges(this.id, this.amt1, this.amt2, this.minKm, this.maxKm,
      this.minAmt, this.freeDelvLimit);

  factory DeliveryCharges.fromJson(Map<String, dynamic> json) =>
      _$DeliveryChargesFromJson(json);
